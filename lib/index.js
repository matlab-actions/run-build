...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const execOptions = {
            env: Object.assign(Object.assign({}, process.env), { "MW_MATLAB_BUILDTOOL_DEFAULT_PLUGINS_FCN_OVERRIDE": "ciplugins.github.getDefaultPlugins" })
        };
        yield run_matlab_command_action_1.matlab.runCommand(helperScript, platform, architecture, (cmd, args) => exec.exec(cmd, args, execOptions), startupOptions).finally(() => {
